...
//#include<linux/if_arp.h>  //Provides declarations for ip header
...
int tcp=0,udp=0,icmp=0,arp=0,total=0,dhcp=0,i,j;
...
void print_arp_packet(unsigned char* Buffer, int Size)
{
    ...
    struct ether_arp *arpheader=(struct ether_arp
    *)(Buffer + iphdrlen + sizeof(struct ethhdr));
